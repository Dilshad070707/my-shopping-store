  ...
  return (
    <div className="store">
      ...
      <div className="topbar">
        🇮🇳 <strong>Made for India</strong> • 100% Secure Shopping • UPI Payments • Easy Checkout
      </div>
...
.size-picker { margin: 16px 0; }
.size-picker-title { font-weight: 900; margin-bottom: 8px; }
.size-options { display: flex; flex-wrap: wrap; gap: 8px; }
.size-option { min-width: 54px; min-height: 42px; padding: 6px 10px; border: 1px solid #d1d5db; background: white; border-radius: 8px; font-weight: 850; }
.size-option.active { background: #7c3aed; color: white; border-color: #7c3aed; }
.size-option:disabled { opacity: .45; cursor: not-allowed; }
